  <section id="footer-section" class="footer-section pt-5">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <img src="{{asset('assets/frontend/assets/img/playStore.png')}}" alt="Play Store" class="img img-fluid pt-3">
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              ...
              <ul class="text-custom-p text-left p-0">
                ...
                <li class="d-block mb-3 footer-contact">
                  ...
                  <a href="#" class="text-custom-p ml-2">info@example.com</a>
                  <hr>
                </li>
                <li class="d-block mb-3 footer-contact">
                  <i class="fas fa-phone-alt"></i>
                  <a href="#" class="text-custom-p ml-2">+1-234-565-890</a>
                  <hr>
                </li>
                <li class="d-block mb-3 footer-contact">
                  <i class="fas fa-map-marker"></i>
                  <a href="#" class="text-custom-p ml-2">Dhaka, Bangladesh</a>
                </li>
              </ul>
    ...
    <div class="text-center">
      <p class="">Copyright &copy;2020 <a href="#"></a> All Rights Reserved</p>
    </div>
</section>