  ...
  <nav class="navbar bg-white navbar-expand-lg fixed-top py-3">
    <div class="container">
      <a class="navbar-brand" href="#">
        <!-- <img src="{{asset('assets/frontend/assets/img/logo.png')}}" alt="TUTORS" class="img img-fluid"> -->
        <p>TUTORS</p>
      </a>
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item {{ $activePage == 'jobBoard' ? ' active' : '' }}">
            <a href="{{ url('job_board')}}" class="nav-link">{{ __('JOB BOARD') }}</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a href="{{Auth::user()->name}}/job_board">Add Job</a>
